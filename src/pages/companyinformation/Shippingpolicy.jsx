...
function Shippingpolicy() {
  return (
    <div>
        <Helmet>
              <title>Shipping Policy | Susha's Foods | Prakash Farm | Organic Food</title>
              <meta
                name="description"
      ...
      <div className="padding-y mt-5">
        ...
        >
          ...
          <Row>
            ...
            <p>
              The use of this website is subject to the following shipping
              terms:
            </p>
            <h3
              id="category-heading"
            ...
            <p>
              <ul>
                <li>
                  ...
                  <strong>2–4 business days</strong> of receiving payment
                  confirmation.
                </li>
                <li>
                  Delivery timelines may vary depending on the{" "}
                  <strong>
                    location, courier partner, and availability of products.
                  </strong>{" "}
                ...
                <li>
                  We make every effort to deliver products on time, but we shall
                  not be liable for delays caused by{" "}
                  <strong>
                    courier companies, postal authorities, natural calamities,
                    or other circumstances beyond our control.
                  </strong>
                </li>
                <li>
                  Products will be delivered only to the{" "}
                  <strong>
                    shipping address provided at the time of order placement.
                  </strong>{" "}
                  Changes in the shipping address after dispatch will not be
                  accepted.
                </li>
                <li>
                  Customers are requested to ensure that{" "}
                  <strong>someone is available to receive the delivery</strong>
                  at the provided address. We will not be responsible for any
                  loss or damage once the package is marked as “delivered” by
                  the courier.
                </li>

                <li>
                  In case of non-delivery due to{" "}
                  <strong>
